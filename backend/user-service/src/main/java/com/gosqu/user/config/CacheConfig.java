...
public class CacheConfig {
    ...
    public RedisCacheManager cacheManager(RedisConnectionFactory factory, ObjectMapper jacksonObjectMapper) {
        ...
        return RedisCacheManager.builder(factory)
                ...
                .withCacheConfiguration("profile", defaults.entryTtl(Duration.ofMinutes(10)))
                .withCacheConfiguration("addresses", defaults.entryTtl(Duration.ofMinutes(5)))
                .build();
    }
